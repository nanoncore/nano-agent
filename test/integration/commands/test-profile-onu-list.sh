...
log_info "Testing profile-onu list for vendor: $VENDOR (protocol: $PROTOCOL)"
...
OUTPUT=$("$BINARY" profile-onu list $CMD_ARGS --json 2>&1) || {
...
log_success "profile-onu list test passed for $VENDOR"
exit 0
