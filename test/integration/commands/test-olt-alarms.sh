...
log_info "Testing olt-alarms for vendor: $VENDOR (protocol: $PROTOCOL)"
...
OUTPUT=$("$BINARY" olt-alarms $CMD_ARGS --json 2>&1) || {
...
TABLE_OUTPUT=$("$BINARY" olt-alarms $CMD_ARGS 2>&1) || {
...
# Summary
# =============================================================================
log_success "All olt-alarms tests passed for $VENDOR"
exit 0
