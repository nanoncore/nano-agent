...
log_info "Testing vlan-list for vendor: $VENDOR (protocol: $PROTOCOL)"
...
OUTPUT=$("$BINARY" vlan-list $CMD_ARGS --json 2>&1) || {
...
# Summary
# =============================================================================
log_success "All vlan-list tests passed for $VENDOR"
exit 0
