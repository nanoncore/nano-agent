...
log_info "Testing profile-onu get for vendor: $VENDOR (protocol: $PROTOCOL)"
...
PROFILE_NAME="HG6143D"

OUTPUT=$("$BINARY" profile-onu get "$PROFILE_NAME" $CMD_ARGS --json 2>&1) || {
...
log_success "profile-onu get test passed for $VENDOR"
exit 0
