...
log_info "Testing onu-provision for vendor: $VENDOR (protocol: $PROTOCOL)"
...
HELP_OUTPUT=$("$BINARY" onu-provision --help 2>&1) || true
...
set +e
ERROR_OUTPUT=$("$BINARY" onu-provision $CMD_ARGS 2>&1)
EXIT_CODE=$?
set -e
...
# Summary
# =============================================================================
log_success "All onu-provision tests passed for $VENDOR"
exit 0
